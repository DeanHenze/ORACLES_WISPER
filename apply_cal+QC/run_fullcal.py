...
Full preprocessing and calibration of all WISPER data files from a call to main.

This script serves as the top-level interface for the user. It includes path 
specification to raw data files and location to save processed files. It also 
includes the flight dates for ORACLES files to process. For data processing, 
it is primarily a wrapper for other scripts, although it does some tidying 
of the data and applies a file header before saving. 
"""
